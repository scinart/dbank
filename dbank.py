...
def wget_download(download_url, file_name, args):
    ...
    if exit_code != 0:
        ...
        sys.stderr.write("ERROR: wget returned %d on getting %s url: %s" % (exit_codeo, file_name, download_url))
...
if __name__ == '__main__':
    ...
    parser.add_argument('-P', '--directory-prefix', dest='path', required=False, help='wget output dir')
